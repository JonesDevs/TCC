...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
    ...
    .logo-titulo { font-weight: 700; font-size: 1.8rem; color: #ffffff; }
...
<body>
      ...
      <div class="painel-central" id="painelPrincipalConteudo">
        ...
        <div class="barra-progresso gamificada">
          ...
          <div class="barra" id="barra">
            ...
            <span class="percentual" id="percentual"><?= round($progressoPercent) ?>%</span>
          </div>
        </div>
  ...
  <script>
    // === Barra de progresso ===
    const progressoUsuario = <?= round($progressoPercent) ?>;
    const barra = document.getElementById("preenchimento");
    const percentual = document.getElementById("percentual");
    barra.style.width = progressoUsuario + "%";
    percentual.textContent = progressoUsuario + "%";
